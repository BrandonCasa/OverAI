...
$modelConfig = Join-Path $repoRoot "configs\rtx4080_1080p.json"
$trainManifest = "C:\Users\brand\Documents\overai\Overwatch\train\train.json"
$validationManifest = "C:\Users\brand\Documents\overai\Overwatch\validation\validation.json"
$output = Join-Path $repoRoot "runs\overwatch-4080"
